...
const IconSvn = () => (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
    <path d="M2 4h12v1.5H2V4zm0 3.25h8v1.5H2V7.25zm0 3.25h10v1.5H2v-1.5z"/>
...
const IconFolder = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M2 4.5A1.5 1.5 0 013.5 3H6l1.5 1.5H12.5A1.5 1.5 0 0114 6v6.5A1.5 1.5 0 0112.5 14h-9A1.5 1.5 0 012 12.5v-8z"/>
  </svg>
);
...
const IconTrash = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M2 4h10M5 4V2.5h4V4M3 4v7.5h8V4"/>
  </svg>
);
...
const IconWarn = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
    <path d="M10 2L1 18h18L10 2zm0 4l5.5 10h-11L10 6zm-1 4h2v4H9v-4zm0 5h2v2H9v-2z"/>
  </svg>
);
...
const IconExternal = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M9 2h3v3M6 8l6-6M5 3H3a1 1 0 00-1 1v8a1 1 0 001 1h8a1 1 0 001-1V9"/>
  </svg>
);
